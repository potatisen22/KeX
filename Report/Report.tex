...
\begin{document}
	...
	We developed a kinematic model for the UAV to describe its motion.
	
	Two right-hand reference frames was defined: the Earth frame and the body frame, as can be seen in \figurename{\ref{fig:frames_rotors}}. 
