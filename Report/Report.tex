...
%		\end{equation}
	...
	To conclude, all the project goals have been met by developing a mathematical model for a single vehicle and successfully implementing a full control with a linearisation-based LQR controller and a potential fields-based navigation controller.\\
