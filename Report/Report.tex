...
\begin{document}
	...
	For the trajectory tracking we constructed the state-space equations of the linearised mathematical model in a MatLab script and used basic algebraic operations to analyse the controllability and observability of the model.  We then used MatLab tools to design an LQR and analysed the step responses of the system.  \\
	...
	\subsection{Trajectory Tracking}
		...
		\begin{figure}[H]
  			...
  			\caption{Step response for position}
