...
The goals for the milestones have also been updated thanks to the feedback we got from the final workplan delivered.
	...
	\begin{tabular}[H]{|C{2cm}|C{2cm}|C{7cm}|C{3cm}|} \hline
		...
		Control & Tracking & Make a controller that makes our UAV go in a certain direction with stability. It is the first step of out control phase since it is more related with the previous phase. &  \textcolor{red}{5-Mar} $\rightarrow$ \textcolor{red}{24-Mar}\\ \cline{2-4}
		...
		Multi-agent case & Model & Starts after the single case modelling and control are finished and tested. Work on the model for a multi-UAV scenario. & \textcolor{red}{29-Mar} $\rightarrow$ 6-Apr\\ \cline{2-4}
